...
function Perfil() {
    ...
    return (
        <div className="p-4 space-x-6 w-full h-160 flex items-center rounded-2xl">
            <div className="w-130 h-130 border-4 border-gray-100 flex-col items-center justify-center rounded-2xl shrink-0">
                <img src="src\assets\foto_perfil.png" alt="Foto de perfil" className="rounded-2xl overflow-hidden"  />
            </div>
